...
public class HeadImageController {
    ...
    public ModelAndView uploadHeadImage(HttpServletRequest request,
        ...
        //绝对路径
        String realPath = scheme + "://" + serverName + ":" + serverPort + contextPath;
        String resourcePath = "/static/images/uploadImages/userLogo/";
        ...
        try {
            ...
            if (FileUploadUtil.allowUpload(imgFile.getContentType())) {
                ...
                //上传路径
                String uploadPath = SysConfigUtils.getRealPath() + imgFolder;
                ...
                try {
                    ...
                    BufferedImage bi = ImageIO.read(new File(uploadPath + "\\_src.jpg"));//读取原图
                    ...
                    if (srcWidth >= imageW && srcHeight >= imageH) {//裁剪后的比原图小
                        ...
                        g.dispose();
                        //输出裁剪后的图片
                        ImageIO.write(tag, "JPEG", new File(uploadPath + "\\_cut.jpg"));
                        File cutedFile = new File(uploadPath, "\\_cut.jpg");
                        //读取裁剪后的图片
                        BufferedImage cutedImage = ImageIO.read(new File(uploadPath + "\\_cut.jpg"));
                        ...
                        ImageIO.write(tag3, "JPEG", new File(uploadPath + "\\180x180.jpg"));
                        ...
                        ImageIO.write(tag2, "JPEG", new File(uploadPath + "\\50x50.jpg"));
                        ...
                        ImageIO.write(tag1, "JPEG", new File(uploadPath + "\\30x30.jpg"));
